...
- **Product:** agent that draws (GLSL) · user steers (1–5 ratings) · learns user taste · user becomes the artist
- **Spirit:** everyday sketches, small change from the last, toward what you love ([Lieberman essay](https://zachlieberman.medium.com/i-spent-10-years-making-a-sketch-in-code-every-day-and-heres-what-i-learned-b845e811160d))
