...
async function callGeminiFallback(systemInstruction, userPrompt, { jsonMode, maxTokens, label }) {
  ...
  lastRoutedModel = GEMINI_MODEL;
  console.log(`[Gemini ${GEMINI_MODEL}] ${label} (fallback)`);
